...
const features = [
  {
    ...
    title: `Unlimited Forms`, desc: `Build as many forms as your business needs — lead capture, intake, event registrations, surveys.`
  },
  {
    icon: (
      <svg className="w-6 h-6 text-[#38bdf8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: `Conditional Logic`, desc: `Show or hide fields based on previous answers. Create branching paths that guide respondents intelligently.`
  },
  {
    icon: (
      <svg className="w-6 h-6 text-[#38bdf8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: `File Uploads`, desc: `Let respondents upload files directly in your form. Stored securely and linked to their submission.`
  },
  {
    icon: (
      <svg className="w-6 h-6 text-[#38bdf8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: `Electronic Signatures`, desc: `Add a signature field to any form. Legally binding e-signatures with timestamp and IP logging.`
  },
  {
    icon: (
      <svg className="w-6 h-6 text-[#38bdf8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: `Auto-CRM Sync`, desc: `Every ZiggyIntake submission automatically creates or updates a contact in ZiggyHQ. No Zapier needed.`
  },
  {
    icon: (
      <svg className="w-6 h-6 text-[#38bdf8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: `Analytics`, desc: `See form conversion rates, drop-off points, average completion time, and answer distribution.`
  },
]
const heroFacts = [
  '$19/mo — Typeform charges $29 with response limits',
  'Unlimited responses on Pro',
  '10-app suite available',
  'Support from the team that built it',
]
const stats = [
  { value: '$19/mo', label: 'Unlimited everything', color: '#38bdf8' },
  { value: 'Auto', label: 'CRM sync', color: '#0ea5e9' },
  { value: 'Logic', label: 'Conditional paths', color: '#10b981' },
    ...
    <div className="bg-[#0a0a0a] min-h-screen" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
      ...
      <section className="relative overflow-hidden pt-32 pb-24 px-4 bg-[#0a0a0a]">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[600px] bg-[#38bdf8]/12 rounded-full blur-3xl" />
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#38bdf8]/10 border border-[#38bdf8]/20 text-[#38bdf8] text-xs font-semibold uppercase tracking-widest mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
            <Link href="https://app.ziggyintake.com/signup" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#38bdf8] text-white rounded-xl font-semibold text-lg hover:opacity-90 hover:scale-105 transition-all">
              Start Free Trial
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
            </Link>
            <Link href="/features" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#38bdf8]/10 border border-[#38bdf8]/30 text-[#38bdf8] rounded-xl font-semibold text-lg hover:bg-[#38bdf8]/20 transition-all">
              See Features
            </Link>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mt-12 pt-8 border-t border-[#1f1f1f]">
            {heroFacts.map((f) => (
              <div key={f} className="flex items-center gap-2 text-sm text-[#b3b3b3]">
                <div className="w-1.5 h-1.5 rounded-full bg-[#38bdf8]" />{f}
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 md:py-32 px-4 bg-gradient-to-b from-[#0a0a0a] via-[#0c0f14] to-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-semibold uppercase tracking-widest text-[#38bdf8] mb-3">Features</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {features.map((f) => (
              <div key={f.title} className="bg-[#111111] border border-[#1f1f1f] rounded-2xl p-6 md:p-8 hover:border-[#38bdf8]/30 hover:shadow-[0_0_30px_rgba(56,189,248,0.08)] transition-all group">
                <div className="w-12 h-12 rounded-xl bg-[#38bdf8]/10 border border-[#38bdf8]/20 flex items-center justify-center mb-5 group-hover:bg-[#38bdf8]/20 transition-colors">
                  {f.icon}
                </div>
          ...
          <div className="text-center mt-12">
            <Link href="/features" className="inline-flex items-center gap-2 px-8 py-4 bg-[#38bdf8]/10 border border-[#38bdf8]/30 text-[#38bdf8] rounded-xl font-semibold hover:bg-[#38bdf8]/20 transition-all">
              View all features
            </Link>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden py-24 md:py-32 px-4 bg-gradient-to-br from-[#080c10] via-[#0d1828] to-[#080c10]">
        <div className="absolute top-0 right-0 w-[600px] h-[400px] bg-[#38bdf8]/6 rounded-full blur-3xl pointer-events-none" />
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xs font-semibold uppercase tracking-widest text-[#38bdf8] mb-4">Our story</p>
          ...
          <div className="space-y-6 text-lg text-[#b3b3b3] leading-relaxed">
            <p>Typeform charges $29/month and limits your responses. We built unlimited forms, unlimited responses, conditional logic, and CRM sync for $19/mo.</p>
            <p className="text-white font-medium">That&apos;s ZiggyIntake. Built by people who get it, for people who need it.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
            {stats.map((s, i) => (
              <div key={i} className="bg-[#111111] border border-[#1f1f1f] rounded-xl p-5 text-center hover:border-[#38bdf8]/30 transition-colors">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto mb-8">
            <div className="bg-[#111111] border border-[#1f1f1f] rounded-2xl p-8 text-left">
              ...
              <Link href="https://app.ziggyintake.com/signup" className="block w-full text-center px-6 py-3 bg-[#38bdf8]/10 border border-[#38bdf8]/30 text-[#38bdf8] rounded-xl font-semibold hover:bg-[#38bdf8]/20 transition-all">Start free trial</Link>
            </div>
            <div className="bg-[#111111] border-2 border-[#38bdf8]/40 rounded-2xl p-8 text-left relative">
              ...
              <Link href="https://app.ziggyintake.com/signup" className="block w-full text-center px-6 py-3 bg-[#38bdf8] text-white rounded-xl font-semibold hover:opacity-90 transition-all">Start free trial</Link>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4 max-w-2xl mx-auto mb-4">
            <div className="bg-[#111111] border border-[#1f1f1f] rounded-xl p-5 text-center">
              <p className="text-[#b3b3b3] text-sm mb-1">Typeform</p>
              <p className="text-3xl font-bold text-white">$29<span className="text-lg text-[#b3b3b3]">/mo</span></p>
              <p className="text-[#e11d48] text-sm mt-1">$14 more per month</p>
            </div>
            <div className="bg-[#111111] border border-[#1f1f1f] rounded-xl p-5 text-center">
              <p className="text-[#b3b3b3] text-sm mb-1">Jotform</p>
              <p className="text-3xl font-bold text-white">$39<span className="text-lg text-[#b3b3b3]">/mo</span></p>
          ...
          <div className="p-4 bg-[#22c55e]/10 border border-[#22c55e]/20 rounded-xl max-w-2xl mx-auto mb-8">
            <p className="text-[#22c55e] font-bold text-lg">Save up to $168/year with ZiggyIntake</p>
          </div>
          <Link href="/pricing" className="inline-flex items-center gap-2 text-[#38bdf8] hover:underline font-medium">
            View full pricing
      ...
      <section className="py-24 md:py-32 px-4 bg-[#080808]">
        <div className="max-w-3xl mx-auto">
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="bg-[#111111] border border-[#1f1f1f] rounded-2xl overflow-hidden hover:border-[#38bdf8]/20 transition-colors">
                <button className="w-full flex items-center justify-between p-6 md:p-8 text-left" onClick={() => setOpenFaq(openFaq === i ? null : i)}>
                  ...
                  <svg className={`w-5 h-5 text-[#38bdf8] flex-shrink-0 transition-transform ${openFaq === i ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <p className="text-center text-[#b3b3b3] mt-8">More questions? <Link href="/faq" className="text-[#38bdf8] hover:underline">View full FAQ</Link></p>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden py-24 md:py-32 px-4 bg-gradient-to-br from-[#080c10] via-[#0c1520] to-[#080c10]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-[#38bdf8]">the smarter way?</span>
          </h2>
          <p className="text-xl text-[#b3b3b3] mb-10">14 days free. No credit card. Cancel anytime.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="https://app.ziggyintake.com/signup" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-10 py-5 bg-[#38bdf8] text-white rounded-xl font-bold text-xl hover:opacity-90 hover:scale-105 transition-all">
              Start Free Trial
            ...
            <Link href="/pricing" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-10 py-5 bg-[#38bdf8]/10 border border-[#38bdf8]/30 text-[#38bdf8] rounded-xl font-bold text-xl hover:bg-[#38bdf8]/20 transition-all">
              View Pricing
            </Link>
          </div>
        </div>
