...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = "https://ziggyintake.com";
  const now = new Date();
  const routes = [
    ...
    { url: "/healthcare", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/service-businesses", priority: 0.8, changeFrequency: "monthly" as const },
    ...
    { url: "/vs/jotform", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/vs/typeform", priority: 0.8, changeFrequency: "monthly" as const },  ];
