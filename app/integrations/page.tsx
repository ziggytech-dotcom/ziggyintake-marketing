...
const nativeIntegrations = [
  { name: `ZiggyHQ`, domain: `ziggyhq.com`, desc: `Auto-create CRM contacts from every form submission` },
  { name: `Stripe`, domain: `stripe.com`, desc: `Collect payment inside forms for paid registrations` },
  { name: `Zapier`, domain: `zapier.com`, desc: `Connect form submissions to 5,000+ apps` },
  { name: `Google Sheets`, domain: `sheets.google.com`, desc: `Stream all responses to a Google Sheet in real time` },
  { name: `Slack`, domain: `slack.com`, desc: `Get notified for every new form submission` },
]
const comingSoon = [
  { name: `HubSpot`, domain: `hubspot.com`, desc: `Sync form submissions directly to HubSpot CRM` },
  { name: `Salesforce`, domain: `salesforce.com`, desc: `Create leads in Salesforce from form submissions` },
  { name: `Mailchimp`, domain: `mailchimp.com`, desc: `Add form respondents to Mailchimp lists` },
]
const suiteApps = [
    ...
    <div className="bg-[#0a0a0a] min-h-screen" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
      ...
      <section className="relative overflow-hidden pt-20 pb-20 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">Works with the tools <span className="text-[#38bdf8]">you already use</span></h1>
          <p className="text-xl text-[#b3b3b3] max-w-2xl mx-auto">ZiggyIntake connects natively with your favorite tools — and via Zapier, with 5,000+ more.</p>
        </div>
      </section>
      <section className="py-16 px-4 border-b border-[#2d2d2d]">
        <div className="max-w-7xl mx-auto">
          <span className="px-2.5 py-1 rounded-full bg-[#38bdf8]/10 border border-[#38bdf8]/20 text-[#38bdf8] text-xs font-medium">Native Suite</span>
      ...
      <section className="py-16 px-4 border-b border-[#2d2d2d]">
        <div className="max-w-7xl mx-auto">
          <span className="px-2.5 py-1 rounded-full bg-[#38bdf8]/10 border border-[#38bdf8]/20 text-[#38bdf8] text-xs font-medium mb-6 inline-block">Native Integrations</span>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {nativeIntegrations.map((i) => (
              <div key={i.name} className="bg-[#111111] border border-[#1f1f1f] rounded-xl p-5 hover:border-[#38bdf8]/30 transition-colors flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="inline-block mt-2 px-2 py-0.5 bg-[#38bdf8]/10 text-[#38bdf8] text-xs rounded-full">Native</span>
                </div>
              </div>
            ))}
          </div>
